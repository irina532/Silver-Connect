...
//echo $providerId;
  ...
  $sql1 = "UPDATE `silver connect`.`service_provider` SET Points = Points + 50 WHERE Provider_Id = '$providerId'";
...
$sql2 = "UPDATE `silver connect`.`elderly` SET Points = Points - 50 WHERE Elderly_Id = '$id'";
...
foreach ($as_ar as $key => $value) {
    ...
    echo "<p>Provider: <a href='mediprofile.php?providerId=$key'>$value</a></p>";
...
echo "<form action='medi.php' method='post'>";
