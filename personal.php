...
//echo $providerId;
  ...
  $sql1 = "UPDATE `silver connect`.`service_provider` SET Points = Points + 30 WHERE Provider_Id = '$providerId'";
...
$sql2 = "UPDATE `silver connect`.`elderly` SET Points = Points - 30 WHERE Elderly_Id = '$id'";
...
$mail->SMTPAuth   = true;
$mail->Username   = 'ishratjereen.cse.cu@gmail.com';
$mail->Password   = 'akod hykl udqh eltk';
$mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS;
$mail->Port       = 465;

// Recipients
$mail->setFrom('ishratjereen.cse.cu@gmail.com', 'SilverConnect');
$mail->addAddress('ishratjereen01@gmail.com', 'Dear Service provider');
...
// Send email and display errors if any
if (!$mail->send()) {
...
<div class="container">
    <div class="service-provider">
        <h2>Personal Care(30)</h2><br>
        <a href="personal.php" class="log">Request Service</a>
        <button> Request Service</button>
        <form action="" method="post">
            <input type="submit" name="Request Service" value="Request Service">
        </form>
...
foreach ($as_ar as $key => $value) {
    ...
    echo "<p>Provider: <a href='perprofile.php?providerId=$key'>$value</a></p>";
