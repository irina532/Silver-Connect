...
//echo $providerId;
  ...
  $sql1 = "UPDATE `silver connect`.`service_provider` SET Points = Points + 10 WHERE Provider_Id = '$providerId'";
...
$sql2 = "UPDATE `silver connect`.`elderly` SET Points = Points - 10 WHERE Elderly_Id = '$id'";
...
foreach ($as_ar as $key => $value) {
    ...
    echo "<p>Provider: <a href='finanprofile.php?providerId=$key'>$value</a></p>";
...
echo "<form action='finan.php' method='post'>";
